...
4.  在“代码”页签下，可以修改如[表2](#table1971225953712)、[表3](#table1742559193710)所示信息。带\*参数为必填项。
    ...
    **表 2**  代码配置信息表
    ...
    <td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p7742559193717"><a name="p7742559193717"></a><a name="p7742559193717"></a>操作说明如<a href="#table1742559193710">表3</a>所示。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
4.  在“配置”页签，修改配置参数，如[表5](#table23322187145854)所示，带\*参数为必填项。
    ...
    **表 5**  配置参数表
    ...
    <td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p65169974145854"><a name="p65169974145854"></a><a name="p65169974145854"></a>数据取值范围为：128、256、512、768、1024、1280、1536、1792、2048、2560、3072、3584、4096。根据需要修改。</p>
    </td>
    </tr>
