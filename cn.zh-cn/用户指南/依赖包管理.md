...
4.  <a name="li224619133510"></a>输入依赖包名称、运行时语言和OBS存储链接，如[图1](#fig19291348174016)所示，单击“确定”。

    **图 1**  设置依赖包<a name="fig19291348174016"></a>  
    ![](figures/设置依赖包.png "设置依赖包")

5.  进入函数详情页面，在“代码”页签，单击“依赖代码包”所在行的“添加”，选择[4](#li224619133510)中创建的依赖包，如[图2](#fig99985398482)所示，单击“确定”。

    **图 2**  添加依赖包<a name="fig99985398482"></a>  
    ![](figures/添加依赖包.png "添加依赖包")

6.  在代码中引入依赖库，单击“保存”，完成函数的修改。
