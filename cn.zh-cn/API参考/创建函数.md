...
<td class="cellrowborder" valign="top" width="65%" headers="mcps1.2.5.1.4 "><p id="p1893873718203"><a name="p1893873718203"></a><a name="p1893873718203"></a>函数的执行环境，取值：Node.js 6.10、Node.js 8.10、Python 2.7、Python 3.6、Java 8、Go 1.8、C#.NET Core 2.0、C#.NET Core 2.1和PHP 7.3。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="65%" headers="mcps1.2.5.1.4 "><p id="p1177102817469"><a name="p1177102817469"></a><a name="p1177102817469"></a>函数代码，当“code_type”为“inline”、“zip”或“jar”时必选，且代码必须要进行base64编码。</p>
</td>
</tr>
</tbody>
</table>
