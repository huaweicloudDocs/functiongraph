...
URL：/v2/\{project\_id\}/fgs/functions?marker=\{marker\}&maxitems=\{maxitems\}
...
```
GET
/v2/7aad83af3e8d42e99ac194e8419e2c9b/fgs/functions?marker=0&maxitems=400 HTTP/1.1
```
